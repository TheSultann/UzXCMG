      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-5 lg:px-6">
        ...
        <div className="space-y-2">
          {faqItems.map((item, index) => (
            ...
            >
              <summary className="flex cursor-pointer list-none items-center justify-between px-4 py-4 text-[14px] font-medium text-[#2d2d2d]">
                <span>{item}</span>
                <ChevronDown className="h-4 w-4 text-[#555555] transition-transform group-open:rotate-180" />
              </summary>
              <div className="px-4 pb-4 text-[14px] leading-[1.7] text-[#555555]">
