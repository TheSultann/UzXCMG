...
export const PageHeroBanner = ({ title }: PageHeroBannerProps) => {
  return (
    <section className="relative overflow-hidden bg-[#161616]">
      ...
      <div className="relative mx-auto flex min-h-[128px] w-full max-w-[1238px] items-center justify-center px-4 py-[20px] sm:min-h-[182px] sm:px-5 sm:py-[28px] lg:px-6">
