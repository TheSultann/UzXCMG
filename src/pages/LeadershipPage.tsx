            ...
            {leaders.map((leader) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1 pt-[2px]">
                  ...
                  <h3 className="mb-[14px] text-[14px] leading-none text-[#4d4d4d]">{leader.name}</h3>
                  <p className="mb-[6px] text-[13px] leading-none text-[#595959]">Xizmat telefoni</p>

                  <div className="mb-[18px] flex items-center gap-[4px] text-[12px] leading-none text-[#595959]">
                    <Phone className="h-[12px] w-[12px] text-[#2f2f2f]" strokeWidth={1.8} />
                    <span>{leader.phone}</span>
                  </div>

                  <Link
                    to={`/leadership/${leader.id}`}
                    className="inline-flex h-[34px] items-center justify-center bg-[#313131] px-[14px] text-[12px] font-medium text-white transition-all duration-300 hover:-translate-y-[1px] hover:bg-[#202020] hover:shadow-[0_10px_18px_rgba(49,49,49,0.24)]"
                  >
